...
(function() {
    ...
    files.forEach(file => {
        ...
        test(`file "${file}"`, (done) => {
            ...
            // return compareScreenshots(expectedFilePath, actualFilePath, resultFilePath)
            //     .then(numDiffPixels => {
            ...
            // compareScreenshotsBlinkdiff(expectedFilePath, actualFilePath, resultFilePath)
            //     .then(isMatch => {
